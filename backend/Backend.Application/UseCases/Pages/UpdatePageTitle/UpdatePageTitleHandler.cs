...
public class UpdatePageTitleHandler
{
    private readonly IPageRepository _pageRepository;
    private readonly IOrgRepository _orgRepository;
    private readonly IUnitOfWork _unitOfWork;

    public UpdatePageTitleHandler(
    ...
    public async Task HandleAsync(UpdatePageTitleCommand command)
    {
        ...
        page.ChangeTitle(command.NewTitle, command.UserId);
